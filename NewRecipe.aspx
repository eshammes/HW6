...
&nbsp; |
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="recipeID" DataSourceID="sql_recipeData" DefaultMode="Insert" Height="50px" Width="257px">
            <Fields>
